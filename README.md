...
См. `docs/plans/mvp-limitations.md` для полного списка.
...
См. `docs/reference/package-format.md` для полного формата.
...
См. `docs/reference/resource-model.md`.

## CLI справка

См. `docs/guides/cli.md` для всех команд и опций.

## Roadmap

См. `docs/plans/roadmap.md` дл�� плана развития.
...
```
docs/
  reference/   # Стабильные спецификации форматов
  guides/      # Мануалы для пользователей
  plans/       # Планы разработки
  meta/        # Миграции, оперативная память
```

- Форматы: `package-format.md`, `lockfile.md`, `registry-format.md`, `baseline-format.md`, `resource-model.md`
- Мануалы: `cli.md`
- Планы: `roadmap.md`, `mvp-limitations.md`
